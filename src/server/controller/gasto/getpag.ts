...
export const validation_gasto_page = validation({
...
export const getpage_by_query = async (req:Request<object,object,object,propsId_pag>,res:Response)=>{
    if(/*req.query.limit && req.query.page*/req.query.id_caixa && req.query.data_inicio && req.query.data_fim){
        const provider = await database.gasto_provider.gasto_get_page(/*req.query.limit,req.query.page,*/req.query.id_caixa,req.query.data_inicio,req.query.data_fim);
